...
- Name: 05-payment-flow.spec.js >> PAY-01 - Customer creates booking successfully
- Location: tests\05-payment-flow.spec.js:16:1
      ...
      - generic [ref=e55]:
        ...
        - generic [ref=e57]:
          - generic [ref=e58]:
            ...
            - generic [ref=e60]:
              - img [ref=e61]
              - textbox "John Doe" [ref=e64]: Payment Test Customer
          - generic [ref=e65]:
            - generic [ref=e66]: Email Address
            - generic [ref=e67]:
              - img [ref=e68]
              - textbox "you@example.com" [ref=e71]: pay_cust_1780458342999@test.com
          - generic [ref=e72]:
