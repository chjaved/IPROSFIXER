...
- Name: 03-customer-dashboard.spec.js >> CUST-01 - Dashboard overview loads with all stat cards
- Location: tests\03-customer-dashboard.spec.js:12:1
      ...
      - generic [ref=e55]:
        ...
        - generic [ref=e57]:
          - generic [ref=e58]:
            ...
            - generic [ref=e60]:
              - img [ref=e61]
              - textbox "John Doe" [ref=e64]: Ahmad Dashboard Tester
          - generic [ref=e65]:
            - generic [ref=e66]: Email Address
            - generic [ref=e67]:
              - img [ref=e68]
              - textbox "you@example.com" [ref=e71]: cust_dash_1780456582701@test.com
          - generic [ref=e72]:
