...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Insert customers (users table uses type='consumer', TEXT id, password_hash)
    ...
    // Insert professionals (professional fields live in professional_profiles)
    ...
    // Create 30 bookings across different statuses
    ...
    for (let i = 0; i < 30; i++) {
      ...
      // Create transaction for completed bookings (payer=consumer, payee=professional)
      if (status === 'completed') {
    ...
    // Update professional ratings and total_jobs from real data
