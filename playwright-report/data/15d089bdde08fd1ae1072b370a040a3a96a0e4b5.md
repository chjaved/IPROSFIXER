...
- Name: customer.spec.js >> Customer Dashboard >> Bookings page loads
- Location: tests\customer.spec.js:32:3
      ...
      - generic [ref=e55]:
        ...
        - generic [ref=e57]:
          ...
          - generic [ref=e65]:
            ...
            - generic [ref=e67]:
              - img [ref=e68]
              - textbox "you@example.com" [ref=e71]: cust_1780248943045@test.com
          - generic [ref=e72]:
