...
const HIW_STEPS = [
  {
    ...
    img: 'https://images.unsplash.com/photo-1512428559087-560fa0db7f59?w=400&q=80',
    imgAlt: 'Person using smartphone to book home cleaning service online',
  },
  {
    n: '2',
    ...
    imgAlt: 'Mobile phone showing WhatsApp notification message received',
  },
  {
    n: '3',
    title: 'They show up and do the job',
    desc: 'Vetted, insured, on time. You can track them live.',
    img: 'https://images.unsplash.com/photo-1628177142898-93e36e4e3a50?w=400&q=80',
    imgAlt: 'Professional cleaner with cleaning supplies arriving at home',
  },
  {
    n: '4',
    title: 'Pay after. Rate your pro',
    desc: "Cash, DuitNow, TnG or GrabPay. Only pay when you're satisfied.",
    img: 'https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?w=400&q=80',
    imgAlt: 'Contactless payment using smartphone QR code scan',
  },
]
